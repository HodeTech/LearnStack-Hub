...
> **Status: ⏳ Not started.** Depends on [P02c-1](p02c-1-hub-domain-core.md) and [P02c-2](p02c-2-internal-api-and-contract.md). **Cross-repo** — the LearnStack-side `SignedLicenseKeyEntitlementProvider` skeleton ships in a coordinated pull request; its operational hardening is [LearnStack Phase 11](https://github.com/HodeTech/LearnStack/blob/main/docs/roadmap/phase-11-production-hardening.md).
...
that, and
[ADR-0020](https://github.com/HodeTech/LearnStack/blob/main/docs/decisions/0020-triple-deployment-hybrid-license.md)
...
whose trigger — per
[ADR-0035](https://github.com/HodeTech/LearnStack/blob/main/docs/decisions/0035-demand-gated-infrastructure.md) — is
...
- **RSA-2048 minimum**, RS256. The verifier rejects anything weaker;
  ...
  ([ADR-0020 § Architecture tests](https://github.com/HodeTech/LearnStack/blob/main/docs/decisions/0020-triple-deployment-hybrid-license.md))
  asserts it.
...
[Hybrid License Model § 1](https://github.com/HodeTech/LearnStack/blob/main/docs/architecture/26-hybrid-license-model.md).
...
[Hybrid License Model § 7](https://github.com/HodeTech/LearnStack/blob/main/docs/architecture/26-hybrid-license-model.md)
...
- The payload shape sits inside
  [ADR-0020's](https://github.com/HodeTech/LearnStack/blob/main/docs/decisions/0020-triple-deployment-hybrid-license.md)
...
endpoint.**
[ADR-0020](https://github.com/HodeTech/LearnStack/blob/main/docs/decisions/0020-triple-deployment-hybrid-license.md)
describes it that way; [Hybrid License Model § 7](https://github.com/HodeTech/LearnStack/blob/main/docs/architecture/26-hybrid-license-model.md)
...
**Production hardening is [LearnStack Phase 11](https://github.com/HodeTech/LearnStack/blob/main/docs/roadmap/phase-11-production-hardening.md)**,
per [ADR-0035](https://github.com/HodeTech/LearnStack/blob/main/docs/decisions/0035-demand-gated-infrastructure.md):
...
- **Phone-home client certificate in the licence bundle.**
  [ADR-0034 § One auth chain, both directions](https://github.com/HodeTech/LearnStack/blob/main/docs/decisions/0034-hub-contract-surface-invariant.md)
