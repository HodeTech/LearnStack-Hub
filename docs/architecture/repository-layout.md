...
| Modules           | 7 (Tenancy, Identity, Customization, Audit, Content, Media, Education) — directories exist, domain code lands across Phase 02a packets 6–9                                                            | 11 planned; **none on `main`** — the P02c-1 four have written specs and a frozen branch                                                                                  |
