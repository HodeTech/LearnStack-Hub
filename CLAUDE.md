...
Then pick an entry-point skill from the sibling repo's catalogue (`.claude/skills/` under `learnstack/`). Hub does not maintain its own skill catalogue; LearnStack's skills apply by reference.
